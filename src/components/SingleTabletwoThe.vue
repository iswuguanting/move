...
export default {
    ...
    computed: {
        ...mapState(["searchIdtwo", "searchShowthree"]),
        show() {
            return this.searchShowthree;
        },
    },
    methods: {
        ...mapMutations(["getsearchShowthree", "searchIdendtwo"]),
        ...
        // 关闭页面
        exit() {
            this.getsearchShowthree(false);
            // 爱心那些清零
        },
        // https://apis.netstart.cn/music/dj/program?rid=977456480&limit=20
        ddsaxios(ids) {
            this.$axios
                .get("/playlist/detail", {
                    params: {
