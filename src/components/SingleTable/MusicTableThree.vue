<template>
    <div class="main-music" ref="resd">
        ...
        <div
            ...
            :class="{ musicaid: MusicId == item.id }"
        >
            <div class="musicclo-shuju">
...
export default {
    ...
    methods: {
        ...
        getaxoDatamusic(id){
            // https://apis.netstart.cn/music/playlist/track/all?id=19723756&limit=50
            this.$axios.get(`https://apis.netstart.cn/music/playlist/track/all?id=${id}&limit=50`).then((res) => {
